...
import type { ComponentProps, KeyboardEvent, PointerEvent as ReactPointerEvent } from 'react'
...
export function Slider(rawProps: SliderProps) {
  const {
    ...
    ...rest
  } = rawProps as SliderProps & { mode?: SliderMode }
    ...
    >
      ...
      {contTickCount > 0 && (
        <span
          ...
          style={{ gridTemplateColumns: `repeat(${contTickCount}, minmax(0, 1fr))`, gap: '2px' }}
        >
