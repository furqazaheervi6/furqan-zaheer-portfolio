 ...
 * lime on focus / red on error) grows from an 80px minimum, top-aligned. Provide
 * `error` for the invalid state; `rows` sets the initial height.
 *
    ...
    <Field.Root className={cx('q-field', className)} {...fieldProps}>
      ...
      >
        ...
        <Field.Control
          ...
          // attrs/handlers at runtime — cast bridges the element-type variance.
          {...(controlProps as ComponentProps<typeof Field.Control>)}
        />
